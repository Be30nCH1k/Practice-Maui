...
public class QuizViewModel : BaseViewModel
{
    ...
    private static string GetRandomFact()
    {
        string[] facts =
        {
            "ФАКТ: За зачёт порой приходится поработать язычком.",
            "ФАКТ: Поговаривают у Льва второй размер груди.",
            "ФАКТ: Молния бьёт в одно место дважды. Часто.",
            "ФАКТ: Мёд не портится — нашли мёд в египетских гробницах и он был съедобен.",
            "ФАКТ: Кошки не чувствуют сладкого вкуса. Наверное.",
        };
    ...
    {
        string[] badges = { "🏅 На сегодня хватит", "🏅 Эроист-террорист", "🏅 Да ты боженька!", "🏅 Выжившие будут завидовать мёртвым" };
